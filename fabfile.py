...
@task
def prod():
    env.prefix = 'source /home/webmaster/.virtualenvs/pangolinland/bin/activate'
    env.user = 'webmaster'
    env.hosts = ['pangolinland.com']
    env.path = '/home/webmaster/apps/pangolinland'
    env.branch = 'master'
    env.db_name = 'pangolinland'
    env.app = 'pangolinland'
...
def test():
    env.prefix = 'source /home/webmaster/.virtualenvs/pangolinland/bin/activate'
    env.user = 'webmaster'
    env.hosts = ['test.pangolinland.com']
    env.path = '/home/webmaster/apps/pangolinland'
    env.branch = 'master'
    env.db_name = 'pangolinland'
    env.app = 'pangolinland'
